...
export const SERVICES_FALLBACK: Record<string, ServiceContent> = {
  ...
  'neural-networks-training': {
    ...
    faq: [
      ...
      { q: 'Кто ведёт занятия?', a: 'Иван Салин — пионер применения генеративного ИИ в бизнесе, 300+ часов обучения нейросетям, дважды лауреат федеральных премий, эксперт по промышленной безопасности с 20-летним опытом.' },
