...
const SERVICES: Record<string, ServiceSeo> = {
  'corporate-ai-video': {
    name: 'Создание корпоративных видеороликов с ИИ-аватарами',
  ...
  'ai-video-training': {
    name: 'Обучение созданию корпоративных обучающих роликов с помощью ИИ',
  ...
  'neural-networks-training': {
    name: 'Обучение использованию генеративного ИИ в работе и жизни',
