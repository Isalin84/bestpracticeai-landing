...
- [ ] Повторная проверка пользователем с МТС без VPN (захват на сервере до 00:15 MSK 06.09)
- [ ] Если не поможет: тикет хостеру FirstByte (anti-DDoS на 185.139.70.35? ограничения РКН на /24?), запросить IP из другой подсети или вынести фронт на российский CDN/VPS другого хостера
